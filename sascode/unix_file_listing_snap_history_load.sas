/**************************************************************************************************************/
/*  PROGRAM NAME: UNIX_FILE_LISTING_SNAP_HISTORY.SAS 						      	                       	  */
/*  DATE CREATED: 28/04/2021			                                                      				  */
/*  AUTHOR: GEORGE BEEVERS  																				  */
/*																											  */
/*  DESCRIPTION:																							  */
/*  READS IN UNIX / LINUX FILE LISTINGS TO CREATE A DAILY SNAPSHOT OF USAGE. ADDITIONALLY THE DATA CAN BE 	  */
/*  LOADED TO A DIMENSION HISTORY TABLE SO THAT TRENDS CAN BE EXAMINED.										  */
/*																											  */
/*  INPUTS:								  |              					                        		  */
/*	MACRO DEFAULT NAMES = UNIX_FILE_LISTING_BASE & UNIX_FILE_LISTING_LSLU									  */
/*																											  */
/*  OUTPUTS:                                                                       							  */
/*  M_VA0.UNIX_FILE_LIST_FULL																				  */
...
/*------------------------------------------------------------------------------------------------------------*/
/* DESCRIPTION                                                   								  	  		  */
/* Macros used in the process should be held in a macro catalog or a consistent location where they can be    */
/* automatically compiled. 																					  */
/* Libraries																								  */
/* M_VA0 - this should be an area for daily snapshots to be loaded. If VA (Visual Analytics) is available then*/
/* load the files and create interactive reports.															  */
/* DETAIL0 - this is the location of the history dataset													  */
/*------------------------------------------------------------------------------------------------------------*/
%include 'C:\temp\GIT\SAS-Code\macros\type2loader.sas';
%include 'C:\temp\GIT\SAS-Code\macros\get_unix_file_list.sas';
...
/*------------------------------------------------------------------------------------------------------------*/
/*CAUTION: Uncomment this if you are testing the setup and wish to remove the history table*/
/*CAUTION: Remove at the point of implementation to avoid the file being removed*/
...
/*		from*/
/*			detail0.unix_file_list_full_dh*/
/*		where filename ="/mnt/c/temp/batch_sub/log/batch_code1.log";*/
/*quit;*/